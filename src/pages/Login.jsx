...
const Login = () => {
  ...
  //---USECONTEXT
  const { connect, address, loginUser, token } = useContext(InstanceContext);
      ...
      <div className='w-full h-screen  bg-slate-900'>
        <div className='flex flex-col h-screen justify-center'>
          ...
          <center className='pt-2'>
            {
              address ?
                <input className='w-56 p-1 font-semibold  text-lg hover:bg-blue-500 text-white bg-blue-400 cursor-pointer' type="submit" onClick={loginFunc} value='Login' />
                :
                <input className='w-56 p-1 font-semibold  text-lg hover:bg-blue-500 text-white bg-blue-400 cursor-pointer' type="submit" onClick={() => connect()} value='Connect To Wallet' />

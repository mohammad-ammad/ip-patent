        ...
        <div className='w-full h-[50px] bg-slate-600' >
           ...
           <div ><img src={Logo} className='w-6 h-5'/></div>
            <div className='hidden md:flex'>
                ...
                <li className='p-2'></li>
                    <li className='px-1  inline-flex items-center '><AiFillHome className='mx-1 text-xl'/></li>
                    ...
                    <li  className='px-1 inline-flex items-center text-sm '  ><img src={ethlogo} className='w-3 h-4 mr-1'/>Pool(Testing)</li>
                    <li  className='px-1 inline-flex items-center text-sm' ><img src={metaLogo} className='w-4 h-4 mr-1'/>Add IP 2 MetaMask</li>

                </ul>
            </div>
          
            <div className='sm:hidden md:block'> <BiLogIn className='mx-1 text-xl'/>Login</div>

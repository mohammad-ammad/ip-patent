  ...
  return (
    <>
        <div className='w-full h-[50px] bg-slate-600' >
            <div className='max-w-[1240px] flex mx-auto px-4 justify-between items-center h-full'>
           <div ><BiBell/></div>
            <div className='hidden md:flex'>
                <ul className='flex text-white text-center'>
                <li className='p-2'></li>
                    <li className='p-2 inline-flex items-center '><AiFillHome/></li>
                    <li className='p-2 inline-flex items-center'><MdCall className='p-2 q'/>Call</li>

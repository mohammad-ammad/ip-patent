           ...
           <div className='' ><a href='https://client.aragon.org/#/IP/'><img src={Logo}  className='w-6 h-5'/></a></div>
            <div className='hidden md:flex  '>
                <ul className='flex md:my-3 md:justify-evenly md:items-center md:flex-wrap text-white text-center'>
                    ...
                    <li  className='px-3 inline-flex items-center text-sm cursor-pointer hover:text-red-900'  ><a href='https://www.cre8.wtf/index.html'> <CgWebsite className='mx-1 text-xl'/>IP DAO</a></li>
                    <li  className='px-3 inline-flex items-center text-sm cursor-pointer hover:text-red-900' ><Link to='/mint' ><FaYinYang className='mx-1 text-xl'/> Mint</Link></li>
                    <li  className='px-3 inline-flex items-center text-sm cursor-pointer hover:text-red-900' ><Link to='/marketplace' ><SiMarketo className='mx-1 text-xl'/> Marketplace</Link></li>
            ...
            <ul>
                <li className='p-2'></li>
                    ...
                    <li  className='px-2 pt-4 flex-col items-center text-sm cursor-pointer hover:text-red-900'  ><a href='https://www.cre8.wtf/index.html'><img src={ethlogo} className='w-3 inline-flex h-4 mr-1'/>IP DAO</a></li>
                    <li  className='px-2 pt-4 items-center text-sm cursor-pointer hover:text-red-900'  ><Link to='/mint' ><img src={metaLogo} className='w-4 inline-flex h-4 mr-1'/> Mint</Link></li>
                    <li  className='px-2 pt-4 items-center text-sm cursor-pointer hover:text-red-900'  ><Link to='/marketplace' ><SiMarketo className='w-4 inline-flex h-4 mr-1'/> Marketplace</Link></li>

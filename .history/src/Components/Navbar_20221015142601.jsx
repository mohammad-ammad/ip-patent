    ...
    <>
        <div className='w-full md:h-auto lg:h-[50px]  bg-slate-600 border   border-b border-gray-900 ' >
           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <div onClick={handleNav} className='block md:hidden border   border-b border-gray-900'>
                {nav? <AiOutlineClose size={30} className='text-white border   border-b border-gray-900'/>:<AiOutlineMenu size={30} className='text-white border border-b-1 border-gray-900'/>}
            </div>
            {/* mobile view  */}

            ...
            <div className='hidden md:flex  '>
                <ul className='flex md:my-3 md:justify-evenly md:items-center md:flex-wrap text-white text-center'>
                    ...
                    <li className='px-3  inline-flex items-center '><Link to='/'> <AiFillHome className=' text-xl'/></Link></li>
                        ...
                        <li  className='px-3 inline-flex items-center text-sm cursor-pointer hover:text-red-900' ><FaYinYang className='mx-1 text-xl'/><Link to='/list' > Listing</Link></li>
            ...
            </div>
          {
            ...
            <ul>
                <li className='p-2'></li>
                {
                    ...
                    <li  className='px-2 pt-4 items-center text-sm cursor-pointer hover:text-red-900'  ><img src={metaLogo} className='w-4 inline-flex h-4 mr-1'/><Link to='/list' > List</Link></li>

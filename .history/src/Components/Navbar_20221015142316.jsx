...
const Navbar = () => {
  ...
  return (
    <>
        <div className='w-full md:h-auto lg:h-[50px]  bg-slate-600 border   border-b-1 border-gray-900 ' >
           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <div onClick={handleNav} className='block md:hidden '>
                {nav? <AiOutlineClose size={30} className='text-white border   border-b-1 border-gray-900'/>:<AiOutlineMenu size={30} className='text-white border border-b-1 border-gray-900'/>}
            </div>
            {/* mobile view  */}
            <div className={nav? 'md:hidden w-full  top-[30px] text-white left-0 absolute flex flex-row  items-center bg-slate-600 left':' hidden'}>
            <ul>
                <li className='p-2'></li>

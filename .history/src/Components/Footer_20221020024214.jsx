...
const Footer = () => {
  ...
  <>
          ...
          <li  className='px-1 inline-flex items-center text-sm cursor-pointer hover:text-red-900' ><a href='https://twitter.com/'><AiOutlineTwitter className='mx-1 text-xl'/></a></li>

           ...
           <div className='' ><a href='https://client.aragon.org/#/IP/'><img src={Logo}  className='w-6 h-5'/></a></div>
            <div className='hidden md:flex  '>
                <ul className='flex md:my-3 md:justify-evenly md:items-center md:flex-wrap text-white text-center'>
                    ...
                    <li  className='px-1 inline-flex items-center text-sm cursor-pointer hover:text-red-900'  ><img src={ethlogo} className='w-3 h-4 mr-1'/><a href=''> IP DAO</a></li>
            ...
            <ul>
                <li className='p-2'></li>
                    <li className='px-2   items-center '><a href="#"> <AiFillHome className=' text-xl'/></a></li>

           ...
           <div ><BiBell/></div>
            <div className='hidden md:flex'>
                ...
                <li className='p-2'></li>
                    ...
                    <li  className='p-2 inline-flex items-center' >Email</li>
                    <li  className='p-2 inline-flex items-center' >Whitepaper</li>
                    <li  className='p-2 inline-flex items-center' >Register Patents</li>
                    <li  className='p-2 inline-flex items-center' >Our Ecosystem</li>

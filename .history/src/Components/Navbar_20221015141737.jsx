...
const Navbar = () => {
  ...
  return (
    <>
        <div className='w-full md:h-auto lg:h-[50px] bg-slate-600 border-2 bottom  border-stone-800 ' >
           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <div onClick={handleNav} className='block md:hidden '>
                {nav? <AiOutlineClose size={30} className='text-white'/>:<AiOutlineMenu size={30} className='text-white border-2'/>}
            </div>
            {/* mobile view  */}

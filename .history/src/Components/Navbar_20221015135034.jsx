           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <ul>
                <li className='p-2'></li>
                    ...
                    <li className='px-1  items-center text-sm cursor-pointer hover:text-red-900'><MdCall className=' flex-inline mx-1 text-xl'/>Call</li>
                    ...
                    <li  className='px-1 items-center text-sm cursor-pointer hover:text-red-900'  ><img src={ethlogo} className='w-3 h-4 mr-1'/>Pool(Testing)</li>

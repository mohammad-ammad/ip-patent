        ...
        <div className='w-full h-[50px] bg-slate-600' >
           ...
           <div ><BiBell/></div>
            <div className='hidden md:flex'>
                ...
                <li className='p-2'></li>
                    <li className='p-2 inline-flex items-center text-s'><AiFillHome /></li>
                    <li className='p-2 inline-flex items-center'><MdCall className='mx-1.5 text-xl'/>Call</li>
                    <li  className='p-2 inline-flex items-center' ><HiOutlineMail className='mx-1.5 text-xl'/> Email</li>
                    <li  className='p-2 inline-flex items-center' ><BsPaperclip className='mx-1.5 text-xl'/>Whitepaper</li>

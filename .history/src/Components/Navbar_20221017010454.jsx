  ...
  return (
    <>
        <div className=' w-full md:h-auto lg:h-[55px] xl:h-auto  bg-[#343D46] border   border-b border-gray-900 ' >
            <div className='w-full  flex flex-wrap lg:flex-row md:flex-col  mx-auto px-4 justify-between  items-center h-full'>
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <div className='hidden md:block text-white cursor-pointer hover:text-red-900'> <BiLogIn className='mx-1 text-xl inline-flex'/> <Link to='/login'> Login </Link></div>

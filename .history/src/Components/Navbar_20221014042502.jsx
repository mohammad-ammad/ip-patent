  ...
  return (
    <>
        <div className='w-full h-[50px] bg-slate-600' >
            <div className='w-full bg-red-400 sm:justify-start flex mx-auto px-4 justify-between items-center h-full'>
           <div ><BiBell/></div>
            ...
            <div className=''> <BiLogIn className='mx-1 text-xl'/>Login</div>

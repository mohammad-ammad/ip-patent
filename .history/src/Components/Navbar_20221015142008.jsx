...
const Navbar = () => {
  ...
  return (
    <>
        <div className='w-full md:h-auto lg:h-[50px] bg-slate-600 border-2 bottom  border-b-1 border-gray-900 ' >
           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <div onClick={handleNav} className='block md:hidden '>
                {nav? <AiOutlineClose size={30} className='text-white'/>:<AiOutlineMenu size={30} className='text-white border border-'/>}
            </div>
            {/* mobile view  */}

...
const Footer = () => {
  return (
  <>
           <div className='w-full flex flex-wrap align-bottom justify-end mt-[500px] bg-slate-600 border   border-b border-gray-900 ' >
          <div className='flex '>
          <ul className='flex md:my-3 md:justify-evenly md:items-center md:flex-wrap text-white '>

           ...
           <div ><BiBell/></div>
            <div className='hidden md:flex'>
                ...
                <li className='p-2'></li>
                    ...
                    <li  className='px-1 inline-flex items-center text-sm '  ><img src={ethlogo} className='w-3 h-6 mr-1'/>Pool(Testing)</li>
                    <li  className='px-1 inline-flex items-center text-sm' ><img src={metaLogo} className='w-3 h-6 mr-1'/>Add IP 2 MetaMask</li>

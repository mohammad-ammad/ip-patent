           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <ul>
                <li className='p-2'></li>
                    ...
                    <li  className='px-1 pt-2 flex-col items-center text-sm cursor-pointer hover:text-red-900'  ><img src={ethlogo} className='w-3 inline-flex h-4 mr-1'/>Pool(Testing)</li>
                    <li  className='px-1 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><img src={metaLogo} className='w-4 inline-flex h-4 mr-1'/> Add IP 2 MetaMask</li>

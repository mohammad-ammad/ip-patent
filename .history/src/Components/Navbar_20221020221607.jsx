           ...
           <div className='' ><a href='https://client.aragon.org/#/IP/'><img src={Logo}  className='w-6 h-5'/></a></div>
            <div className='hidden md:flex  '>
                <ul className='flex md:my-3 md:justify-evenly md:items-center md:flex-wrap text-white text-center'>
                    ...
                    <li  className='px-1 inline-flex items-center text-sm cursor-pointer hover:text-red-900'  ><CgWebsite className='mx-1 text-xl'/><a href='https://www.cre8.wtf/index.html'> IP DAO</a></li>
            ...
            <div className='hidden md:block text-white cursor-pointer hover:text-red-900'> <BiLogIn className=' text-xl inline-flex'/>  Log out </div>
            ...
            <ul>
                <li className='p-2'></li>
                    ...
                    <li  className='px-0 pt-4 items-center text-sm cursor-pointer hover:text-red-900' ><BiLogIn className='mx-1 text-xl inline-flex'/> <Link to=''> Log Out </Link></li>

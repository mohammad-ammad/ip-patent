...
const Navbar = () => {
  ...
  return (
    <>
        <div className='w-full md:h-auto lg:h-[50px] bg-slate-600' >
           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            {/* mobile view  */}
            <div className={nav? 'md:hidden w-full  top-[30px] text-white left-0 absolute flex flex-row  items-center bg-gray-900 left':' hidden'}>
            <ul>
                <li className='p-2'></li>
                    <li className='px-2   items-center '><AiFillHome className=' text-xl'/></li>
                    <li className='px-1 pt-2  items-center text-sm cursor-pointer hover:text-red-900'><MdCall className='mx-1 inline-flex text-xl'/>Call</li>
                    <li  className='px-1 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><HiOutlineMail className='mx-1 inline-flex text-xl'/> Email</li>
                    <li  className='px-1 pt-2  items-center text-sm cursor-pointer hover:text-red-900' ><BsPaperclip className='mx-1 inline-flex text-xl'/>Whitepaper</li>
                    <li  className='px-1 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><TbFiles className='mx-1 inline-flex text-xl'/>Register Patents</li>
                    <li  className='px-1 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><MdLocalFireDepartment className='mx-1 inline-flex text-xl'/>Our Ecosystem</li>
                    <li  className='px-1 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><HiUsers className='mx-1 inline-flex text-xl'/>Resources</li>
                    <li  className='px-1 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><FaYinYang className='mx-1 inline-flex text-xl'/>Our Tokenomics</li>
                    <li  className='px-2 pt-2 flex-col items-center text-sm cursor-pointer hover:text-red-900'  ><img src={ethlogo} className='w-3 inline-flex h-4 mr-1'/>Pool(Testing)</li>
                    <li  className='px-2 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><img src={metaLogo} className='w-4 inline-flex h-4 mr-1'/> Add IP 2 MetaMask</li>
                    <li  className='px-2 pt-2 items-center text-sm cursor-pointer hover:text-red-900' ><BiLogIn className='mx-1 text-xl inline-flex'/> Login</li>

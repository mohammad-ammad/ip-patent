           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <ul>
                <li className='p-2'></li>
                    ...
                    <li  className='px-1  items-center text-sm cursor-pointer hover:text-red-900' ><TbFiles className='mx-1 text-xl'/>Register Patents</li>
                    <li  className='px-1  items-center text-sm cursor-pointer hover:text-red-900' ><MdLocalFireDepartment className='mx-1 text-xl'/>Our Ecosystem</li>
                    <li  className='px-1  items-center text-sm cursor-pointer hover:text-red-900' ><HiUsers className='mx-1 text-xl'/>Resources</li>
                    <li  className='px-1  items-center text-sm cursor-pointer hover:text-red-900' ><FaYinYang className='mx-1 text-xl'/>Our Tokenomics</li>
                    <li  className='px-1  flex-col items-center text-sm cursor-pointer hover:text-red-900'  ><img src={ethlogo} className='w-3 h-4 mr-1'/>Pool(Testing)</li>
                    <li  className='px-1  items-center text-sm cursor-pointer hover:text-red-900' ><img src={metaLogo} className='w-4 h-4 mr-1'/> Add IP 2 MetaMask</li>

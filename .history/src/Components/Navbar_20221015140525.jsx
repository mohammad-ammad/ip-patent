           ...
           <div className='' ><img src={Logo}  className='w-6 h-5'/></div>
            ...
            <ul>
                <li className='p-2'></li>
                    ...
                    <li className='px-1 pt-3  items-center text-sm cursor-pointer hover:text-red-900'><MdCall className='mx-1 inline-flex text-xl'/>Call</li>
                    <li  className='px-1 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><HiOutlineMail className='mx-1 inline-flex text-xl'/> Email</li>
                    <li  className='px-1 pt-3  items-center text-sm cursor-pointer hover:text-red-900' ><BsPaperclip className='mx-1 inline-flex text-xl'/>Whitepaper</li>
                    <li  className='px-1 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><TbFiles className='mx-1 inline-flex text-xl'/>Register Patents</li>
                    <li  className='px-1 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><MdLocalFireDepartment className='mx-1 inline-flex text-xl'/>Our Ecosystem</li>
                    <li  className='px-1 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><HiUsers className='mx-1 inline-flex text-xl'/>Resources</li>
                    <li  className='px-1 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><FaYinYang className='mx-1 inline-flex text-xl'/>Our Tokenomics</li>
                    <li  className='px-2 pt-3 flex-col items-center text-sm cursor-pointer hover:text-red-900'  ><img src={ethlogo} className='w-3 inline-flex h-4 mr-1'/>Pool(Testing)</li>
                    <li  className='px-2 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><img src={metaLogo} className='w-4 inline-flex h-4 mr-1'/> Add IP 2 MetaMask</li>
                    <li  className='px-0 pt-3 items-center text-sm cursor-pointer hover:text-red-900' ><BiLogIn className='mx-1 text-xl inline-flex'/> Login</li>

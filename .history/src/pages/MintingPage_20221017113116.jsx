            ...
            <div className='flex mt-6 w-8/12 rounded-xl mx-auto shadow-lg overflow-hidden'>
              ...
              <form action='#' className='px-3'>
                <div className='flex  w-[100%]'>
                  ...
                  <input className='py-1 px-2 w-[100%] text-white bg-transparent border border-gray-400' type='text' placeholder='firstname'  />
                  </div>
                  <div className='flex flex-col justify-start ml-1 w-[100%]'>
                  <lable className='py-1 text-lg px'>Quantity</lable>
                  {/* <input className='py-1 px-2 w-[100%] text-white bg-transparent border border-gray-400' type='number' placeholder='exp 1,2..'  /> */}
                  <select className='py-1 px-2 w-[100%] text-white bg-transparent border border-gray-400 ' name='quantity'>
                ...
                <div className='flex w-[100%]'>
                  <div className='flex flex-col justify-start w-[100%]'>
                  <lable className='py-1 text-lg px'>Image</lable>
                  <input className='py-1 px-2 w-[100%] text-white bg-transparent border border-gray-400' type='file' placeholder='firstname'  />
                  </div>
                  <div className='flex flex-col justify-start ml-1 w-[100%]'>

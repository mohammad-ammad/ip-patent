          ...
          <div className="flex w-full mt-6 lg:w-8/12 p-4 rounded-xl mx-auto shadow-lg overflow-hidden">
            <div className="  w-full pb-5 pt-5 px-5 bg-[#373C44] rounded-xl border-2 border-[#660000] bg-opacity-90 text-white">
              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-4 border border-gray-400 bg-transparent py-2 text-gray-400 ">
                  <lable className=' grid-cols-1 text-justify'>Intrest :</lable>
                  <label className=' grid-cols-2 inline-block '>Coding </label>
                  <input className='grid-cols-3 w-4 bg-[#343D46]' type="checkbox" name="third" value="coding "/>

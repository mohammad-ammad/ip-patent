  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <>
                  <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold text-sm">Is it a goods or a service? Please check the Class list definitions:<a className="text-[#5C0000]" href="https://www.nolo.com/legal-encyclopedia/trademark-classes.html" target="blank">Here</a>.
                 <br/> Choose 46 if nothing similar in list.
                  </p>
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                <select
                  className="py-2 md:w-[84%] w-full lg:w-[84%]  px-2 text-white  border bg-[#5C0000]  rounded-sm"

...
const InputForm = () => {
  ...
  return (
    <>
        ...
        <video className='form-video-bg' src={BgVideo} autoPlay muted />
            ...
            <div className='container mx-auto'>
                ...
                <div className='flex mt-6 w-8/12 bg-slate-400 rounded-xl mx-auto shadow-lg overflow-hidden'>
                  <div className='  w-full pb-5 pt-5 px-5 bg-[#373C44]  rounded-xl border-2 border-[#660000] bg-opacity-30 text-white'>
                  <div className='mb-5'>

              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 gap-5">
                  ...
                  {/* <input
                    ...
                    placeholder="30th"
                  /> */}
                  <select className="py-1 px-2 text-white  border bg-transparent border-gray-400 " name="Thirty">
                    <option className="bg-slate-700" value={inputForm.Thirty}>Money Transfer</option>
                    <option className="bg-slate-700" value={inputForm.Thirty}>Smart Contract </option>
                    <option className="bg-slate-700" value={inputForm.Thirty}>NFT</option>
                    <option className="bg-slate-700" value={inputForm.Thirty}>Fungible Tokens </option>
                    <option className="bg-slate-700" value={inputForm.Thirty}>Goverment</option>
                    <option className="bg-slate-700" value={inputForm.Thirty}>Health Care </option>

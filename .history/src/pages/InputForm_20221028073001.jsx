      ...
      try {
        toast
          .promise(
            axios({
              method: "post",
              url: ` http://ec2-15-188-56-8.eu-west-3.compute.amazonaws.com/api/v1/form/file/qwer`,
          ...
          .then((res) => {
            ...
            localStorage.setItem(address,localStorage.getItem(address)+1)
            :
              localStorage.setItem(address,setCount(count+1))
           
            console.log("key in localstorage",window.localStorage.key(address))
    ...
    <>
      <div className="min-h-screen py-8 ">
        ...
        <div className="container mx-auto">
          ...
          <h2 className=" flex justify-center text-[#660000] font-semibold">Patent Collections</h2>
          ...
          <div className="flex justify-center w-full mx-auto mt-6 lg:w-8/12 p-4 pb-0">
            ...
            <div className=" w-full pb-5 pt-5 px-4 rounded-xl border-2 bg-[#373C44] border-[#660000] bg-opacity-90">
              <div className="flex justify-between ">
               <label className="text-lg text-gray-400">Your patent collection:</label>
          ...
          <div className="flex w-full mt-6 lg:w-8/12 p-4 rounded-xl mx-auto shadow-lg overflow-hidden">
            ...
            <div className="  w-full pb-5 pt-5 px-5 bg-[#373C44] rounded-xl border-2 border-[#660000] bg-opacity-90 text-white">
              ...
              <form action="#" className="px-3">
                ...
                <div className="flex lg:flex-row md:flex-col  flex-col justify-evenly  bg-transparent border border-gray-400 text-gray-400 py-1">
                
                  <label className="">Intrest</label>
                  <label className="inline-block" >Coding</label>
                  <input className="w-4 " type='checkbox' name="third"  onChange={HandlerForm}  value='Coding'/>
                  <label className="" >Travelling</label>
                  <input className="w-4 " type='checkbox' name="fourth"  onChange={HandlerForm} value='Travelling'/>
                  ...
                  <input className="w-4" type='checkbox' name="fifth"  onChange={HandlerForm}  value='English'/>
                  <label className="" >Spanish</label>
                  <input className="w-4 " type='checkbox' name="sixth"  onChange={HandlerForm} value='Spanish'/>
                  </div>
                </div>

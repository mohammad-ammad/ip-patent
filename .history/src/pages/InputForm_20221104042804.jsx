      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
        ...
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 ...
                 <textarea
                    ...
                    value={inputForm.purpose}
                    onChange={HandlerForm}
                    placeholder="insert  a brif general description of the short-comings of what is known our cruntely used,but don't discuss specefic products or patents because there is a significant risk that such comments will prejudice your later non-professional..."
                  ></textarea>
                </div>
                </>:nextPreState==10?
                <>

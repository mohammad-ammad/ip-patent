  ...
  return (
    <>
      ...
      <div class="flex justify-center  flex-col">
        ...
        <p className="flex justify-center w-[84%]">For your name, use the name on your driver’s license or other permanent documentation.</p>
       
      <div className=" flex justify-center pb-2 ">
                <select
                  className="py-2 w-[84%]  px-2 text-white  border bg-transparent border-gray-400 rounded-lg"

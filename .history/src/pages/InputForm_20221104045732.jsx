...
What is the purpose of your Invention?:</p>
        ...
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 ...
                 <textarea
                  ...
                  <>
                 <p className="flex sm:justify-center  md:justify-start lg:justify-start  lg:px-16  font-bold text-sm">Known Prior Patents or Published Applications:<a className="   text-[#5C0000]" href="https://www.nolo.com/legal-encyclopedia/trademark-classes.html" target="blank">Here</a>.
                  Choose 46 if nothing similar in list.
                  </p>
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 <textarea

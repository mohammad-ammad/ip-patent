              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 gap-5">
                  ...
                  {/* <input
                    ...
                    placeholder="30th"
                  /> */}
                  <select className="py-1 px-2 text-white bg-slate-700 border border-gray-400 " name="">
                    <option className="">Money Transfer</option>
                    <option className="">Smart Contract </option>
                    <option className="">NFT</option>
                    <option className="">Fungible Tokens </option>
                    <option className="">Goverment</option>

  ...
  return (
    ...
    <div className='w-full h-screen  bg-slate-900'>
        <div className='flex flex-col h-screen justify-center'>
            ...
            <center className='text-white text-3xl pt-3'>
                <h1>IPCRE8</h1>
            </center>
            ...
            <center className='pt-2'>
                <input className='w-56 p-1 bold  text-lg hover:bg-blue-500 text-white bg-blue-400 cursor-pointer' type="submit" value='Login' />
            </center>
            <center className="pt-2">

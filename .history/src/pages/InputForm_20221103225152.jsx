  ...
  return (
    <>
                ...
                <div className=" mt-2 flex justify-end w-full   ">
                  {
                    nextPreState>0?<>
                <button
                    className="text-lg font-semibold  bg-[#5C0000] w-[15%] py-2 mr-2 "
                    onClick={Previous}
                  >
                    Previous
                  </button>
      ...
      <div className="text-center mt-[20px] ">
        {
          nextPreState==0?
        <span className="h-[15px] w-[15px] mr-[2px]  bg-[#5C0000]    rounded-[50%] inline-block pr-2"></span>
        :
        <span className="h-[15px] w-[15px] mr-[2px]  bg-white  opacity-[0.5] rounded-[50%] inline-block pr-2"></span>
        }
        {
          nextPreState==1?
        <span className="h-[15px] w-[15px] mr-[2px]  bg-[#5C0000] rounded-[50%] inline-block "></span>
       
       : <span className="h-[15px] w-[15px] mr-[2px] bg-white opacity-[0.5] rounded-[50%] inline-block "></span>

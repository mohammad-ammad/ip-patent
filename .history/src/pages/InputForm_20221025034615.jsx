              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 gap-5">
                  ...
                  {/* <input
                    ...
                    placeholder="30th"
                  /> */}
                  <select className="py-1 px-2 text-white bg-transparent border border-gray-400 " name="">
                    <option className="bg-transparent">Money Transfer</option>
                    <option className="bg-transparent">Smart Contract </option>
                    <option className="bg-transparent">NFT</option>
                    <option className="bg-transparent">Fungible Tokens </option>
                    <option className="bg-transparent">Goverment</option>
                    <option className="bg-transparent">Health Care </option>

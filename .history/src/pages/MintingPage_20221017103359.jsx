            ...
            <div className='flex mt-6 w-8/12 rounded-xl mx-auto shadow-lg overflow-hidden'>
              ...
              <form action='#' className='px-3'>
                <div className='flex justify-start'>
                  ...
                  <input className='py-1 px-2 w-49% text-white bg-transparent border border-gray-400' type='text' placeholder='firstname'  />
                  </div>
                ...
                <div className='flex justify-start'>
                  ...
                  <input className='py-1 px-2 w-49% text-white bg-transparent border border-gray-400' type='file' placeholder='firstname'  />
                  </div>
                  <div className='flex flex-col justify-start ml-1'>

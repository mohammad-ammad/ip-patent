          ...
          <div className="flex w-full mt-6 lg:w-8/12 p-4 rounded-xl mx-auto shadow-lg overflow-hidden">
            <div className="  w-full pb-5 pt-5 px-5 bg-[#373C44] rounded-xl border-2 border-[#660000] bg-opacity-90 text-white">
              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-9 border border-gray-400 bg-transparent  ">
                  <lable className='text-sm text-justify'>Choose your intrest :</lable>
                  <label className='inline-block text-sm'>Coding </label>
                  <input className='w-4 text-sm' type="checkbox" name="third" value="coding "/>
                  <label className='inline-block text-sm'>Coding </label>
                  <input className='inline-block text-sm  w-4' type="checkbox" name="third" value="coding "/>
                  <label className='inline-block text-sm'>Coding </label>
                  <input className='inline-block w-4 text-sm' type="checkbox" name="third" value="coding "/>
                  <label className='inline-block text-sm'>Coding </label>
                  <input className='inline-block w-4 text-sm' type="checkbox" name="third" value="coding "/>
                  {/* <input
                    className="py-1 px-2 text-white bg-transparent border border-gray-400"

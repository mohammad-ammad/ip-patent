    ...
    <>
      <div className="min-h-screen py-8 ">
        ...
        <div className="container mx-auto">
          ...
          <div className="flex justify-center w-full mx-auto mt-6 lg:w-8/12 p-4">
            
            <div className=" w-full pb-5 pt-5 px-4 rounded-xl border-2 border-[#660000] bg-opacity-90">

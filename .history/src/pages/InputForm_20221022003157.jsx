      ...
      try {
        ...
        toast
          ...
          .then((res) => {
            ...
            // const {...deStructMetadata}=metadata;
            // const ipfsHash=res.data.IpfsHash;
          //   axios({
          //     method:"post",
          //     url:http:`//localhost:8000/api/v1/form/create/${ipfsHash}`,
          //     data:deStructMetadata,
          //   })
          //   .then((metaResp)=>{
          //     console.log("DB response:",metaResp);
    ...
    <>
      <div className="min-h-screen py-8 ">
        ...
        <div className="container mx-auto">
          <h1 className=" flex text-[#B87333] font-semibold text-4xl  justify-center">
          IP DAO
          </h1>

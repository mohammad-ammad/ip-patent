          ...
          <div className="flex w-full mt-6 lg:w-8/12 p-4 rounded-xl mx-auto shadow-lg overflow-hidden">
            <div className="  w-full pb-5 pt-5 px-5 bg-[#373C44] rounded-xl border-2 border-[#660000] bg-opacity-90 text-white">
              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 gap-5">
                <textarea cols='5' rows='3' className="py-1 px-2 text-white bg-transparent border border-gray-400" placeholder="31th"></textarea>
                  ...
                  {/* <input
                    ...
                    placeholder="32th"
                  /> */}
                  <textarea cols='5' rows='3' className="py-1 px-2 text-white bg-transparent border border-gray-400" placeholder="32th"></textarea>
                </div>

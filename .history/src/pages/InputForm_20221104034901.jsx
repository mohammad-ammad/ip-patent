  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
        ...
        <div className=" flex flex-col md:justify-center lg:justify-center  sm:justify-start pb-2">
                  <input
                    className="py-2 px-2 md:w-[84%] w-full lg:w-[84%]  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="generic_title"
                  ...
                  />
                 <p className="flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold text-sm ">What is the purpose of your Invention?:</p>
                 <textarea
                    cols="5"
                    rows="3"
                    className="py-2 px-2 md:w-[84%] w-full lg:w-[84%]  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"

  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <>
  <div>  
               <p className="flex sm:justify-center  md:justify-start lg:justify-start  lg:px-16  font-bold text-sm">Is it a goods or a service? Please check the Class list definitions:
     
               <a className="   text-[#5C0000]" href="https://www.nolo.com/legal-encyclopedia/trademark-classes.html" target="blank">Here</a>.
                </p>
             </div> 
             <div>
...
What is the purpose of your Invention?:</p>
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                  <input
                    className="py-2 px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="purpose_invention"
                    value={inputForm.purpose_invention}
                    onChange={HandlerForm}
                    type="text"
                 ...
                 <textarea
                    ...
                    rows="5"
                    className="py-2 px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="brif_general_discrp"
                    value={inputForm.brif_general_discrp}
                    onChange={HandlerForm}
                    placeholder="insert  a brif general description of the short-comings of what is known our cruntely used,but don't discuss specefic products or patents because there is a significant risk that such comments will prejudice your later non-professional application."
                  ></textarea>
                </div>
                </>:nextPreState==10?
                <>
                   <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold text-sm ">what are the Features of your invention?:</p>
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                  <input
                    className="py-2  px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="features_invention"
                    value={inputForm.features_invention}
                    onChange={HandlerForm}
                    type="text"
                    placeholder="1 to 5 words description of the features of your invention"
                  />
                 <textarea
                    cols="5"
                    rows="5"
                    className="py-2 mt-2 px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="features_general_discrp"
                    value={inputForm.features_general_discrp}
                    onChange={HandlerForm}
                    placeholder="in this section identify what your subject. "
                  ></textarea>
                </div>
                </>:nextPreState==11?
                <>
                         <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold text-sm ">Alternative Embodiments:</p>
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                  <input
                    className="py-2  px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="alternative_embod"
                    value={inputForm.alternative_embod}
                    onChange={HandlerForm}
                    type="text"
                    placeholder="1 to 5 words description of the Alternative Embodiments of your invention"
                  />
                 <textarea
                    cols="5"
                    rows="5"
                    className="py-2 mt-2 px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="alternative_general_discrp"
                    value={inputForm.alternative_general_discrp}
                    onChange={HandlerForm}
                    placeholder="Alternative Embodiments. "
                  ></textarea>
                </div>
                </>:nextPreState==12?
                <>
              <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold text-sm ">Are there related patents to this one?:</p>
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 <textarea
                    cols="5"
                    rows="5"
                    className="py-2 mt-2 px-2  w-full  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="is_related_patents"
                    value={inputForm.is_related_patents}
                    onChange={HandlerForm}
                    placeholder="are there related patents to this one that you have already patented somehwere else?" 
                  ></textarea>
                </div>
                </>:nextPreState==13?
                <>
                  <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold text-sm ">Operation, Function and Use of Invention:</p>
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                  <input
                    className="py-2  px-2  w-full  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="useof_invention"
                    value={inputForm.useof_invention}
                    onChange={HandlerForm}
                    type="text"
                    placeholder="1 to 5 words description of the Function and Use of Invention of your invention"
                  />
                 <textarea
                    cols="5"
                    rows="5"
                    className="py-2 mt-2 px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="useof_invention_discrp"
                    value={inputForm.useof_invention_discrp}
                    onChange={HandlerForm}
                    placeholder="The discription in this section must be suffient to enable reproduction of the subject. "
                  ></textarea>
                </div>
                </>:nextPreState==14?
             ...
             <div>  
               <p className="flex sm:justify-center  md:justify-start lg:justify-start  lg:px-16  font-bold text-sm">Known Prior Patents or Published Applications:
               <a className="   text-[#5C0000]" href="https://patents.justia.com/" target="blank">click here</a>.
                </p>
             </div> 
             <div>
              <p className="flex sm:justify-center  md:justify-start lg:justify-start  lg:px-16  font-bold text-sm">
                
                 using several keywords in your search to verify if there is prior art)
                  </p>
                  </div >
        <div className=" flex flex-col sm:justify-center md:justify-start   lg:px-16 pb-2">
                 <textarea
                    ...
                    rows="5"
                    className="py-2 px-2  w-full   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="known_prior_patents"
                    value={inputForm.known_prior_patents}
                    onChange={HandlerForm}
                    placeholder="Are there any known Prior Patents..."
                  ></textarea>
                </div>
                </>:nextPreState==15?
                <>
                 <p className="flex sm:justify-center  md:justify-start lg:justify-start  lg:px-16  font-bold text-sm">Add Comments

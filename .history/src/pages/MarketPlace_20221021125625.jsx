...
const MarketPlace = () => {
  return (
    ...
    <div className="container bg-gray-900 min-h-screen py-20 ">
        ...
        <div className='border  border-[#FF0000] mx-8 md:mx-12 lg:mx-20 mb-28 mt-10 rounded-3xl'>
            <div className='flex justify-center mb-2'>
                ...
                {/* card */}
                <div className='rounded-xl shadow-lg w-[350px] p-6'>
                    <div className=' p-5 border border-[#B87333]  hover:scale-105 hover:border-[#B87333] rounded-xl'>
                        ...
                        <div className="mt-1">
                  <div className="m-auto flex w-[100%] justify-center bg-[#B87333]  hover:bg-[#c07229]">
                    <button

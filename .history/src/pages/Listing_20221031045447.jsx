...
// const listed=await contract.list(
//     0,
//     InputForm.id,
//     EtherPrice,
//     InputForm.amount
// );
// console.log(await listed.wait());

    toast.promise(
        contract.list(0,formInput.id,EtherPrice,formInput.amount).then((transaction)=>{
            toast.promise(
                transaction
                .wait()
                .then((tx)=>{
        ...
        (erro=>{
            console.log("listing error ",erro)
        })
        // {

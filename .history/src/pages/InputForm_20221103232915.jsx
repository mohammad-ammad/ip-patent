  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <div className=" mt-2 flex  lg:justify-end md:justify-end justify-center   sm:w-full lg:w-full md:w-full   ">
                  {
                    nextPreState>0?<>
                <button
                    className="text-lg font-semibold  bg-[#5C0000]  md:w-[15%] lg:w-[15%] sm:w-full py-2 mr-4 "
                    onClick={Previous}
                  >
                    Previous
                  </button>

...
What is the purpose of your Invention?:</p>
        ...
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 ...
                 <textarea
                  ...
                  <>
                 <p className="flex sm:justify-center  md:justify-start lg:justify-start  lg:px-16  font-bold text-sm">Known Prior Patents or Published Applications:<a className="   text-[#5C0000]" href="https://patents.justia.com/" target="blank">click here</a>.

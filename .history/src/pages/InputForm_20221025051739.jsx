            ...
            <div className="  w-full pb-5 pt-5 px-5 bg-[#373C44] rounded-xl border-2 border-[#660000] bg-opacity-90 text-white">
              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 border  ">
                  <lable className=' text-white bg-transparent border border-gray-400 text-justify'>Intrest :</lable>
                  <label className='text-white bg-transparent border border-gray-400 inline-block '>Coding </label>

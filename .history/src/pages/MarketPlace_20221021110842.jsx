            ...
            <div className='flex justify-center mb-2'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mx-2'>
                    <div className='bg-secondary p-3 mx-auto cursor-pointer hover:scale-105 hover:border border-sky-900 ease-in-out transition-all'>
                        <span style="box-sizing:border-box ;display:inline-block;overflow:hidden ;width:initial; background:none; opacity:1; border:opx; margin:0px;padding:0px;position:relative;max-width: "></span>
                    </div>
                </div>
            </div>
            <div></div>

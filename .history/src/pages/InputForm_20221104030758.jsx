  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
        ...
        <option value="ZW">Zimbabwe</option>
              ...
              <input
                ...
                <>
                  <p className="flex justify-center ">Do you have a trademark?:
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <>
                  <p className="flex justify-center ">Is it a goods or a service? Please check the Class list definitions:<a className="text-[#5C0000]" href="https://www.nolo.com/legal-encyclopedia/trademark-classes.html" target="blank"> Here</a>.

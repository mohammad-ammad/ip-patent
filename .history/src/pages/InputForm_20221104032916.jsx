  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <>
                  <p className="flex sm:justify-center    lg:px-16  font-bold text-sm">Is it a goods or a service? Please check the Class list definitions:<a className=" flex justify-start text-[#5C0000]" href="https://www.nolo.com/legal-encyclopedia/trademark-classes.html" target="blank">Here</a>.

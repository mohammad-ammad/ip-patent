...
toast.promise(contract
      .mint(formInput.quantity, metadataURI)
      .then((tx) =>
      
        tx.wait().then((responce) => console.log("Minted Responce:", responce))
      ).catch(error=> "Mera Error hai Minting Mai: ", error), { pending: "Wait for Transction to Accept", error: "Error in Transaction"})

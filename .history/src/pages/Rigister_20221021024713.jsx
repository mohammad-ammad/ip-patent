    ...
    <>
      <div className="w-full h-screen  bg-slate-900">
        <div className="flex flex-col h-screen justify-center">
          ...
          <center className="pt-2">
            <select onChange={FormHandler} className="w-56 p-1 px-3 text-sm  text-white border-none bg-slate-700">
              <option name value={registerInput.country}>United State</option>
              <option value={registerInput.country}>United Kingdom</option>

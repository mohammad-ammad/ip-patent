              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 gap-5">
                  ...
                  <select className="py-1 px-2 text-white  border bg-transparent border-gray-400 " onChange={HandlerForm} name="Thirty">
                    <option className="bg-slate-700" value='Money Transfer'>Money Transfer</option>
                    <option className="bg-slate-700" value='Smart Contract'>Smart Contract </option>
                    <option className="bg-slate-700" value='NFT'>NFT</option>
                    <option className="bg-slate-700" value='Fungible Tokens'>Fungible Tokens </option>
                    <option className="bg-slate-700" value='Goverment'>Goverment</option>
                    <option className="bg-slate-700" value='Health Care '>Health Care </option>

...
const InputForm = () => {
  ...
  return (
    <>
      ...
      <div class="flex justify-center">For your name, use the name on your driver’s license or other permanent documentation.

</    div>
                <div className="flex justify-center">
                  <input
                    className="py-2 px-2 w-[85%] text-white bg-transparent border border-gray-400 rounded-xl"
                    name="first"

  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <div className=" mt-2 flex md:flex-row  md:justify-end sm:justify-center sm:flex-col  sm:w-full lg:w-full md:w-full   ">
                  {
                    nextPreState>0?<>
                <button
                    className="text-lg font-semibold  bg-[#5C0000] sm:pb-2 md:w-[15%] lg:w-[15%] sm:w-full py-2 mr-2 "
                    onClick={Previous}
                  >
                    Previous
                  </button>
                   <button
                   className="text-lg font-semibold  bg-[#5C0000] sm:mr-2 md:w-[10%] lg:w-[10%] sm:w-full py-2 mr-14 "
                   onClick={Next}
                 >
                   Next
                 </button></>

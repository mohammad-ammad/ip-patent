  ...
  return (
    ...
    <div className='w-full h-screen  bg-slate-900'>
        <div className='flex flex-col h-screen justify-center'>
            ...
            <center className='pt-2'>
                <input className=' w-56 p-1 text-sm border-collapse px-3 text-white  bg-slate-700' type="password" autocomplete="off" value={password} onChange={setPassword(value)} placeholder='Password '/>
            </center> 
            <center className='pt-2'>
                { 
                address?

...
const InputForm = () => {
  ...
  return (
    <>
      ...
      <div class="flex justify-center  flex-col">For your name, use the name on your driver’s license or other permanent documentation.
                ...
                <div className="">
                  <input
                    className="py-2 px-2 w-[84%] justify-center text-white bg-transparent border border-gray-400 rounded-lg"
                    name="first"

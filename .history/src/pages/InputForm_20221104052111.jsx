...
What is the purpose of your Invention?:</p>
        ...
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 ...
                 <textarea
                    cols="5"
                    rows="5"
                    className="py-2 mt-2 px-2 md:w-[84%] w-full lg:w-[84%]  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="brif_general_discrp"
        ...
        <div className=" flex flex-col sm:justify-center md:justify-start  md:px-16 lg:px-16 pb-2">
                 <textarea
                    cols="10"
                    rows="5"
                    className="py-2 px-2 md:w-full w-full lg:w-[84%]  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"

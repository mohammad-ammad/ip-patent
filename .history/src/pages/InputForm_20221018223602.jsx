  ...
  const SendFilesToIPFS = async (event) => {
    ...
    if (
      ...
      try {
        ...
        const{first,seconed,third,fourth,fifth,sixth,seventh,eighth,nineth,tenth,eleventh,tewelveth,thirteen,fourteenth,fifteenth,sixteenth,seventeen,eightheenth,nineteen,twenty,twentyOne,twentyTwo,twentyThree,twentyFour,twentyFive,twentySix,twentySeven,twentyEight,twentyNine,Thirty,ThirtyOne,ThirtyTwo}=inputForm;
        const metadata={
          first:first,
          seconed:seconed,
          third:third,

    ...
    <>
      ...
      <div className="container  min-h-screen py-20 ">
        ...
        <div className="border  border-[#FF0000] mx-8 md:mx-12 lg:mx-20 mb-28 mt-10 rounded-3xl">
          ...
          <div className="p-6 mb-6 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-x-5 gap-y-6">
...
//////////////
<div className="mb overflow-hidden shadow-lg border border-[#B87333]  hover:scale-105 p-4  rounded-xl">
              <img className="w-full" src={car} alt="Mountain" />
            ...
            ////
            <div className=" mb-4 overflow-hidden shadow-lg border border-[#B87333]  hover:scale-105 p-4  rounded-xl">
              <img className="w-full" src={car} alt="Mountain" />

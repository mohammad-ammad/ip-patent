            ...
            <div className='flex mt-6 w-8/12 rounded-xl mx-auto shadow-lg overflow-hidden'>
              ...
              <form action='#' className='px-3'>
                <div className='flex  w-[100%]'>
                  ...
                  <input className='py-1 px-2 w-[100%] text-white bg-transparent border border-gray-400' type='text' name='name' value={formInput.name} onChange={} placeholder='name'  />
                  </div>
                ...
                <div className='flex w-[100%]'>
                  ...
                  <input className='py-0.5 px-2 w-[100%] text-white bg-transparent border border-gray-400' type='file' accept="application/pdf"   />
                  </div>
                </div>

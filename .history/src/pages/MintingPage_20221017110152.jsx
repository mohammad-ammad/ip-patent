  ...
  return (
    ...
    <video className='mint-video-bg' src={BgVideo} autoPlay muted loop />
        ...
        <div className=' w-[100%]'>
            ...
            <div className='flex mt-6 w-10/12 rounded-xl mx-auto shadow-lg overflow-hidden'>
              ...
              <form action='#' className='px-3'>
                ...
                <div className='mt-2'>
                <div className='m-auto flex w-[50%] justify-center hover:bg-blue-600  bg-blue-500'>

  ...
  return (
    <>
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <div className=" flex md:justify-center lg:justify-center  sm:justify-start pb-2">
                  <input
                    className="py-2 px-2 md:w-[84%] w-full lg:w-[84%]  text-white bg-transparent border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="first"
                ...
                <div className=" mt-2 flex sm:flex-col   justify-evenly lg:justify-end md:justify-end   sm:w-full lg:w-full md:w-full   ">
                  {
                    nextPreState>0?<>
                <button
                    className="text-lg font-semibold  bg-[#5C0000]  md:w-[15%] lg:w-[15%] sm:w-full py-2 sm:mr-24 md:mr-2"
                    onClick={Previous}
                  >
                    Previous
                  </button>
                   <button
                   className="text-lg font-semibold  bg-[#5C0000] md:w-[10%] lg:w-[10%] sm:w-full py-2 mr-14 "
                   onClick={Next}
                 >
                   Next
                 </button></>

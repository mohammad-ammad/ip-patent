              ...
              <form action="#" className="px-3">
                ...
                <div className="mt-2 grid grid-cols-2 gap-5">
                  ...
                  <select className="py-1 px-2 text-white  border bg-transparent border-gray-400 " name="">
                    <option className="bg-slate-700">Money Transfer</option>
                    <option className="bg-slate-700">Smart Contract </option>
                    <option className="bg-slate-700">NFT</option>
                    <option className="bg-slate-700">Fungible Tokens </option>
                    <option className="bg-slate-700">Goverment</option>
                    <option className="bg-slate-700">Health Care </option>

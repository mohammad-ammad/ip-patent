            ...
            <div className='container mx-auto'>
                ...
                <div className='flex mt-6 w-8/12 rounded-xl mx-auto shadow-lg overflow-hidden'>
                  ...
                  <form action='#' className='px-3'>
                    ...
                    <input className='py-1 px-2 text-white bg-transparent border border-gray-400' value={formInput.first} name='name' onChange={FormHandler}  type='text' placeholder='first'  />

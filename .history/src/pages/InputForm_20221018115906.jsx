...
const InputForm = () => {
  ...
  const SendFilesToIPFS=async (event)=>{
    ...
    if(inputForm.first!="" || inputForm.seconed!="" || inputForm.third!="" || inputForm.fourth!="" || inputForm.fifth!="" || inputForm.sixth!="" || inputForm.seventh!="" || inputForm.eighth!="" || inputForm.tenth!="" 
     || inputForm.eleventh!="" || inputForm.tewelveth!="" || inputForm.thirteen!="" || inputForm.fourteenth!="" || inputForm.fifteenth!="" || inputForm.sixteenth!="" || inputForm.seventeen!="" || inputForm.eightheenth!="" || inputForm.nineteen!="" || inputForm.twenty!=""
     || inputForm.twentyOne!="" || inputForm.twentyTwo!="" || inputForm.twentyThree!=""|| inputForm.twentyFour!=""|| inputForm.twentyFive!="" || inputForm.twentySix!=""|| inputForm.twentySeven!="" || inputForm.twentyEight!=""|| inputForm.twentyNine!="" 
     || inputForm.Thirty!=""|| inputForm.ThirtyOne!=""|| inputForm.ThirtyTwo!="")
     {
      try{
        const formData = new FormData();
        formData.append("text", inputForm.first);
        ...
        console.log("hashhhhhh: ",fileHash);
            ...
            <div className="  w-full pb-5 pt-5 px-5 bg-[#373C44] rounded-xl border-2 border-[#660000] bg-opacity-90 text-white">
              ...
              <form action="#" className="px-3">
                ...
                <div className=" mt-2 grid grid-cols-1 justify-center hover:bg-blue-600 gap-5 bg-blue-500">
                  <button className="text-lg font-semibold" onClick={SendFilesToIPFS}>Submit</button>
                </div>
              </form>
            </div>
          </div>

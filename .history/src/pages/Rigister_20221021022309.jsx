    ...
    <>
     <div className='w-full h-screen  bg-slate-900'>
        <div className='flex flex-col h-screen justify-center'>
            ...
            <center className='pt-2'>
                <input className=' w-56 p-1 px-3 text-sm  text-white border-none bg-slate-700' type="text"  autocomplete="off" placeholder='Address'/>
            </center>
            <center className='pt-2'>
            <select className='w-56 p-1 px-3 text-sm  text-white border-none bg-slate-700'>
            ...
            <center className='pt-2'>
                <input className=' w-56 p-1 text-sm border-collapse px-3 text-white  bg-slate-700' type="phone"  autocomplete="off" placeholder='Phone '/>
            </center>
            <center className='pt-2'>

  ...
  return (
    <>
      ...
      <div class="flex justify-center  flex-col">
        {nextPreState==0?
        <>
        <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold ">For your name, use the name on your driver’s license or other permanent documentation.</p>
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <>
        <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold  ">Contact info.</p>
        <div className=" flex md:justify-center lg:justify-center  sm:justify-start pb-2">
                  <input
                    className="py-2 px-2 md:w-[84%] w-full lg:w-[84%]  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="metamask"
                ...
                <>
                 <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold ">Login Info.</p>
        <div className=" flex md:justify-center lg:justify-center  sm:justify-start pb-2">
                  <input
                    className="py-2 px-2 md:w-[84%] w-full lg:w-[84%]  text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="username"
                ...
                <>
                 <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold">Your location .</p>
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                <select
                  className="py-2 md:w-[84%] w-full lg:w-[84%]  px-2 text-white  border bg-[#5C0000]  rounded-sm"
                  onChange={HandlerForm}
        ...
        <option value="ZW">Zimbabwe</option>
                ...
                <>
              <p className="flex sm:justify-center md:justify-start  md:px-16 lg:px-16  font-bold ">Birthday.</p>
              <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
              <input
                    className="py-2 px-2 md:w-[84%] w-full lg:w-[84%]   text-white  border border-gray-400 rounded-sm bg-[#5C0000]"
                    name="dob"
                ...
                <>
                  <p className="flex sm:justify-center justify-start md:px-16 lg:px-16 font-bold">Do you have a trademark?:
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                ...
                <>
                  <p className="flex justify-start ">Is it a goods or a service? Please check the Class list definitions:<a className="text-[#5C0000]" href="https://www.nolo.com/legal-encyclopedia/trademark-classes.html" target="blank"> Here</a>.
      ...
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
          ...
          <option value="46">46</option>
                ...
                <>
                 <p className="flex justify-center ">Do you own the patentrights?:  
                  </p>
      <div className=" flex md:justify-center lg:justify-center  sm:justify-start  pb-2 ">
                <select
                  className="py-2 md:w-[84%] w-full lg:w-[84%]  px-2 text-white  border bg-[#5C0000]  rounded-sm"

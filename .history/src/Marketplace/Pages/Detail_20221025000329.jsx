...
}
{
  Moralisresult.map((item,key)=>
          ...
          <h2 className='flex justify-center sm:justify-start  p-3 text-3xl'>{NameParser(item.metadata)}</h2>
          ...
          <div className="flex justify-start mt-2 items-center text-center py-2 border border-[#c07229] rounded-full px-3  ">
          <span className="inline-block text-white cursor-pointer  rounded-full  align-middle text-center text-sm font-semibold  mr-10 mb-2">
                  {item.owner_of}
                </span>
          </div> 
          <div className="my-6">

  ...
  return (
    <>
        ...
        <div className="border    border-[#FF0000] mx-8 md:mx-12 lg:mx-20 mb-28 mt-10 rounded-3xl">
          ...
          {/* card */}
          <div className="text-white justify-center pt-8 mb-8    rounded-xl"> 
          <img className='w-full h-full ' src={car}/>
          </div>
          <div className="text-white justify-center pt-8 mb-8  shadow-lg border border-[#B87333] hover:scale-105 p-4  rounded-xl"> 
          <h2 className='flex justify-center bg-slate-800 p-4 text-4xl'>Owner name </h2>
          </div>
          </div>
          </div>
          </div>

  ...
  return (
    <>
        ...
        <div className="border    border-[#FF0000] mx-8 md:mx-12 lg:mx-20 mb-28 mt-10 rounded-3xl">
          ...
          <div className="text-white justify-center pt-8 border    p-4  rounded-xl"> 
          <img className='w-full h-[450px]   rounded-xl ' src={ImageParser(item.metadata)}/>
          </div>)
}
{
  Moralisresult.map((item,key)=>
          <div className="text-white justify-center  mb-8   p-4 border  rounded-xl"> 

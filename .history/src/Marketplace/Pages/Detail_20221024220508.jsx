    ...
    <>
        ...
        <div className="border    border-[#FF0000] mx-8 md:mx-12 lg:mx-20 mb-28 mt-10 rounded-3xl">
          ...
          <div className="flex justif-start py-2">
                ...
                <span className="inline-block text-white  rounded-full px-3 py-1 text-sm font-semibold  mr-10 mb-2">
                <img className='w-3 h-5 mr-1 inline-block' src={eth}/>  0.06 
                </span>
          </div> 
          <div className="flex justify-between items-center py-2 border rounded-full px-3  ">
                <span className="inline-block text-white  border-spacing-y-2 rounded-full px-3 py-1 text-sm font-semibold  mr-10 mb-2">
                  PDF File 
                </span>

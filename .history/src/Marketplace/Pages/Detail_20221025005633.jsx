...
}
{
  Moralisresult.map((item,key)=>
          ...
          <div className="flex justify-start mt-2 sm:break-words items-center text-center py-2 border border-[#c07229] rounded-full   ">
          <span className="inline-block text-white m-1   rounded-full  align-middle text-center text-sm font-semibold  mr-10 mb-2">
                  {item.owner_of}
                </span>
          </div> 
          <div className="my-6">
